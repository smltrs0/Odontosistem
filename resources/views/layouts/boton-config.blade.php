        ...
        <div class="scrollbar-container">
            <div class="theme-settings__options-wrapper">
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left">
                                        <div class="widget-heading">Cabecera fija
                                        </div>
                        ...
                        <li class="list-group-item">
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left">
                                        <div class="widget-heading">Barra lateral
                                        </div>
                ...
                <div class="p-3">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <h5 class="pb-2">Elige un esquema de color
                            </h5>
                ...
                <h3 class="themeoptions-heading">
                    ...
                    <button type="button" class="btn-pill btn-shadow btn-wide ml-auto active btn btn-focus btn-sm">Restaurar Predeterminado
                    </button>
                </h3>
                <div class="p-3">
                    <ul class="list-group">
