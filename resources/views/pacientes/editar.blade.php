                            ...
                            <div class="tab-pane fade" id="nav-antecedentes" role="tabpanel"
                                ...
                                <div class="form-row mt-1">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" name="antecedentes" id="antecedentes-m">@foreach(json_decode
                                        ($paciente->antecedentes) as $antecedente){{$antecedente.",
                                        "}}@endforeach</textarea>
                                    </div>
                                    <div class="col">
                                        <label for="alergias">Alergias</label>
                                        <textarea class="form-control" name="alergias" id="alergias">@foreach(json_decode
                                        ($paciente->alergias) as $alergia){{$alergia.", "}}@endforeach</textarea>
                                    </div>
                                </div>
                                <div class="form-row mt-1">
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" name="habitos" id="habitos">@foreach(json_decode
                                        ($paciente->habitos) as $habito){{$habito.", "}}@endforeach</textarea>
                                    </div>
                                </div>
                                <div class="form-row mt-1">
                                    <div class="col">
                                    ...
                                    <div class="col-8">
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="list-home" role="tabpanel"
                                                 aria-labelledby="list-home-list"> <button type="button" class="btn
                            ...
                            <div class="modal-body">
                               ...
                               <div class="row">
                                   ...
                                   <div class="form-group col-md-6 col-sm-12">
                                       ...
                                       <textarea class="form-control" name="comentario-paciente" id="comentario-paciente" ></textarea>
                                   </div>
                               </div>
