                            ...
                            <div class="list-group">
                                    ...
                                    <span class="float-right">
										<span class="tooth demo-tooth">
											<span class="side side_bottom pro_restoration"
                                                  style="border-radius: 50%; border-width: 2px;"></span>
										</span>
									</span>
                                </a>
                                ...
                                <a href="#" data-action="49"
                                   class="list-group-item list-group-item-action">
                                    ...
                                    <span class="float-right">
										<i style="font-family: 'Times New Roman',serif">I &nbsp;</i>
									</span>
                                </a>
                                <a href="#" data-action="50"
                                   class="list-group-item list-group-item-action">
                                    ...
                                    <span class="float-right">
										<i style="font-family: 'Times New Roman', serif">II &nbsp;</i>
									</span>
                                </a>
                                <a href="#" data-action="51"
                                   class="list-group-item list-group-item-action">
                                    ...
                                    <span class="float-right">
										<i style="font-family: 'Times New Roman',serif">III &nbsp;</i>
									</span>
                                </a>
